...
<head>
	<title>Draw Education Category Bootstrap Responsive Website Template | Home :: W3layouts</title>
	<!-- Meta tag Keywords -->
	...
	<section class="single_grid_w3_main align-w3 py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<div class="wthree_pvt_title text-center">
				...
				<p class="sub-title">This is a demo text you may write a brief text here to explain the title</p>
			</div>
