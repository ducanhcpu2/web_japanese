...
<head>
	<title>Draw Education Category Bootstrap Responsive Website Template | Contact Us :: W3layouts</title>
	<!-- Meta tag Keywords -->
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-6 mt-md-0 mt-4">
										...
										<input class="form-control" type="text" placeholder="Mk" name="name" required="">
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										...
										<textarea placeholder="type your message here" class="form-control" required=""></textarea>
									</div>
								</div>
							</div>
							<div class="row mt-3">
